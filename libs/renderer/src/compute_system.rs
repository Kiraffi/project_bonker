...
use wgpu::{ShaderModule, PipelineLayout, ComputePipeline, TextureFormat, Device, CommandEncoder, TextureView};
...
impl TriangleSystem
{
    pub fn new(device: &Device, textureformat: TextureFormat) -> Self
    {
        ...
        let compute_pipeline = device.create_compute_pipeline(&wgpu::RenderPipelineDescriptor
        {
            label: None,
